...
def json_parser(file_path, theta):
    ...
    for theta in theta_ls:
        ...
        for root, dirs, files in os.walk(src_anno_dir_list):
            ...
            for file in files:
                ...
                new_json = json_parser(current_anno_file, theta)
                if new_json:
                    # To Do
                    try:
...
if __name__ == "__main__":
    theta_ls = [-15, -30, -45, -60, 15, 30, 45, 60]
    ...
    separated_dir = "/media/qisens/4tb3/kowa_global/parkinglot_detection/dataset/scribble/parking_tower/parking_tower_data/merged/rotated_"
